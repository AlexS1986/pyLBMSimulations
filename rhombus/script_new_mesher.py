...
mesh1 = Mesh_Module.Mesh(name='rhombus', working_directory='./examples/rhombus/', cell_size=0.025, seed_point=seed_point)
...
# computation1 = Computation_Module.Computation(working_directory='./examples/rhombus/', name='rhombus')

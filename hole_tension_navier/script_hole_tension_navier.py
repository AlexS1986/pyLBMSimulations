...
mesh1 = Mesh_Module.Mesh(name='hole', working_directory='./', cell_size=h, seed_point=seed_point)
...
computation1 = Computation_Module.Computation(working_directory='./', name='hole')

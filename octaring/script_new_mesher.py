...
seed_point = Point_Module.Point(2.0, 0.0,0.0)
mesh1 = Mesh_Module.Mesh(name='octaring', working_directory='./examples/octaring/', cell_size=0.025, seed_point=seed_point)
...
# computation1 = Computation_Module.Computation(working_directory='./examples/octaring/', name='octaring')

...
seed_point = Point_Module.Point(1.0, 1.0, 0.0)
mesh1 = Mesh_Module.Mesh(name='disc_with_hole', working_directory='/Users/alex/Work/LBM/PythonImplementierung/pyLBM/examples/test_gradient/', cell_size=h, seed_point=seed_point)
...
computation1 = Computation_Module.Computation(working_directory='/Users/alex/Work/LBM/PythonImplementierung/pyLBM/examples/test_gradient/', name='disc_with_hole')

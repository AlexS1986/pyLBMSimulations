...
mesh1 = Mesh_Module.Mesh(name='disc_with_hole', working_directory='./', cell_size=0.025, seed_point=seed_point,mesh_type='D2Q9')
...
computation1 = Computation_Module.Computation(working_directory='./', name='disc_with_hole')
